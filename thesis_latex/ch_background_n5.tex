...
the need for analytical cost models and structural pruning strategies.
...
This upper bound is useful to understand scale and to motivate
pruning.
...
Section~\ref{sec:loop-ordering}, loop order on them is irrelevant.
