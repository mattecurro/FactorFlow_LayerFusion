...
from 16 to 128~rows, driven entirely by a latency reduction
($2.73 \times 10^{7} \to 2.47 \times 10^{7}$~cc) as energy remains
essentially flat ($< 1$\,\% variation).
ResNet18 exhibits a similar pattern, with EDP decreasing by
approximately~$11$\,\% ($2.55 \times 10^{5} \to 2.27 \times 10^{5}$),
also latency-driven ($9.00 \times 10^{6} \to 8.03 \times 10^{6}$~cc).
