...
\begin{itemize}
  ...
  \item On \textbf{Eyeriss}, full fusion is roughly energy-neutral
        ...
        weight register capacity is $19.7$,M~bytes ($1{,}200$ $\times$ $16{,}384$), each register access contributing to
        per-access energy.
\end{itemize}
...
full fusion reduced the weight memory size up to $3.1\times$ on DepFiN
(VGG16: 14\,366\,KB${\to}$4\,610\,KB; ResNet18:
10\,738\,KB${\to}$4\,608\,KB) and the per-PE weight register (WReg)  size on Eyeriss
