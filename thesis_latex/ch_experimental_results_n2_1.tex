...
to reflect the reduced wordline utilization at smaller tiles.
...
therefore require no modification to either architecture model, and would produce qualitatively
...
For all four workloads, the largest feasible tile size minimizes EDP.
